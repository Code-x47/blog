...
<section class="container">
      <header>Create Posts On Sports</header>
      <form action="createSptPost" class="form" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="input-box">
          <label>Title</label>
    ...
    <!-- View All Science Post Table Starts -->
@section("admincontent2")
<div class="container-fluid pt-4 px-4">
  <div class="bg-light text-center rounded p-4">
       <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">View All Posts On Sports</h6>
                        <a href="">Show All</a>
         </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-success" href="sptPostView/{{$viewDoc['id']}}">View</a></td>
                                </tr>
 ...
 @endsection
<!-- View All Science Post Table Ends -->


<!-- Manage Science Post Table Starts -->
@section("admincontent3")
          <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Manage All Post On Sports</h6>
                        <a href="">Show All</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$viewDoc->created_at->format(config("app.post_date"))}}</td>
                                    <td>
                                    <a class="btn btn-sm btn-primary" href="edit/{{$viewDoc['id']}}">Edit</a>
                                    <a class="btn btn-sm btn-danger" href="deleteSpt/{{$viewDoc['id']}}">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                            @endforeach
            ...
            <!-- Manage Science Post Table Ends -->
