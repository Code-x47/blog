...
<section class="container">
      ...
      <header>Create Posts On Politics</header>
      <form action="/createPolPost" method="Post" class="form" enctype="multipart/form-data">
        @csrf
        <div class="input-box">
          <label>Title</label>
...
@endsection
    ...
    <!-- View All Politics Post Table Starts -->
@section("admincontent2")
<div class="container-fluid pt-4 px-4">
  <div class="bg-light text-center rounded p-4">
       <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">View All Posts On Politics</h6>
                        <a href="">Show All</a>
         </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                              @foreach($view AS $viewDoc)
                                <tr>
                                    <td><input class="form-check-input" type="checkbox"></td>
                                    <td>{{$viewDoc->userPost->name}}</td>
                                    <td>{{$viewDoc['title']}}</td>
                                    <td>{{$viewDoc['tag']}}</td>
                                    <td>{{$viewDoc['summary']}}</td>
                                    <td>{{$viewDoc->created_at->format(config('app.post_date'))}}</td>
                                    <td><a class="btn btn-sm btn-success" href="polPostView/{{$viewDoc['id']}}">View</a></td>
                                </tr>
                               @endforeach
                            </tbody>
                        </table>
 ...
 @endsection
<!-- View All Politics Post Table Ends -->


<!-- Manage Politics Post Table Starts -->
@section("admincontent3")
          <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Manage All Post On Politics</h6>
                        <a href="">Show All</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$viewDoc->created_at->format(config('app.post_date'))}}</td>
                                    <td>
                                    <a class="btn btn-sm btn-primary" href="editPol/{{$viewDoc['id']}}">Edit</a>
                                    <a class="btn btn-sm btn-danger" href="deletePol/{{$viewDoc['id']}}">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
            ...
            <!-- Manage Politics Post Table Ends -->
