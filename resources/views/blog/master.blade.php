...
<body>
    ...
    <!-- End Of Main News Slider Start And Other Blog Content  -->
     <div id="indexFooter">
    ...
    <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
        <div class="row py-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="font-weight-medium"><i class="fa fa-map-marker-alt mr-2"></i>19 Ogugua Street Mainland Emene Enugu State</p>
                <p class="font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>08153777284</p>
                <p class="font-weight-medium"><i class="fa fa-envelope mr-2"></i>info@aproko.com</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="m-n1">
                    ...
                    <a href="" class="btn btn-sm btn-secondary m-1">Sports</a>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">&copy; <a href="#">Aproko Challenge</a>. All Rights Reserved. 
		
		<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
		Design by <a href="https://htmlcodex.com">Tech 360</a><br>
        Distributed by <a href="https://themewagon.com">Kamikaze</a>
    </p>
    </div>
    <!-- Footer End --> --}}
