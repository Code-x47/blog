...
<section class="container">
      <header>Create Posts On Latest News</header>
      <form action="/createLatestPost" method="Post" class="form" enctype="multipart/form-data">
        @csrf
        <div class="input-box">
          <label>Title</label>
    ...
    <!-- View All Latest Post Table Starts -->
@section("admincontent2")
<div class="container-fluid pt-4 px-4">
  <div class="bg-light text-center rounded p-4">
       <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">View All Posts On Latest News</h6>
                        <a href="">Show All</a>
         </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$view1['id']}}</td>
                                    <td>{{$view1->userPost->name}}</td>
                                    <td>{{$view1['title']}}</td>
                                    <td>{{$view1['tag']}}</td>
                                    <td>{{$view1['summary']}}</td>
                                    <td>{{$view1->created_at->format(config('app.post_date'))}}</td>
                                    <td><a class="btn btn-sm btn-success" href="latestPostView/{{$view1['id']}}">View</a></td>
                                </tr>
 ...
 @endsection
<!-- View All Latest Post Table Ends -->


<!-- Manage Latest Post Table Starts -->
@section("admincontent3")
          <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Manage All Post On Latest News</h6>
                        <a href="">Show All</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                           ...
                           @foreach($view2 AS $view2)
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-sm btn-primary" href="editlatest/{{$view2['id']}}">Edit</a>
                                    <a class="btn btn-sm btn-danger" href="deletelatest/{{$view2['id']}}">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                          @endforeach  
