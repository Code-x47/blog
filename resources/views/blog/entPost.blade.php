...
<section class="container">
      ...
      <header>Create Posts On Entertainment</header>
      <form action="/createEntPost" method="Post" class="form" enctype="multipart/form-data">
        @csrf
        <div class="input-box">
          <label>Title</label>
...
@endsection
    <!-- View All Entertainment Post Table Starts -->
...
<div class="container-fluid pt-4 px-4">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-success" href="entPostView/{{$view['id']}}">View</a></td>
                                </tr>
 ...
 @endsection
<!-- View All Entertainment Post Table Ends -->


<!-- Manage Entertainment Post Table Starts -->
@section("admincontent3")
          <div class="container-fluid pt-4 px-4">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    @can("task_edit_post")
                                    <a class="btn btn-sm btn-primary" href="editEnt/{{$view2['id']}}">Edit</a>
                                    @endcan
                                    <a class="btn btn-sm btn-danger" href="delete/{{$view2['id']}}">Delete</a>
                                    </td>
                                </tr>
            ...
            <!-- Manage Entertainment Post Table Ends -->
