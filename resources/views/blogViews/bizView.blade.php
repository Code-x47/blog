            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="/bizdoc/{{$viewbiz['file1']}}" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="">{{$viewbiz['tag']}}</a>
                                <a class="text-body" href="">{{$viewbiz->created_at->format(config('app.post_date'))}}</a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">{{$viewbiz['title']}}</h1>
                            <p>{{$viewbiz['body']}}</p> 
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="/docs/{{$viewbiz->userPost->pics}}" width="25" height="25" alt="">
                                <span>{{$viewbiz->userPost->name}}</span>
                            </div>
                            <div class="d-flex align-items-center">
                     ...
                     <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            @foreach($vComment AS $comments)
                                @if($comments['businesses_id'] == $viewbiz['id'])
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <form action="/bizcomment" method="POST">
                            @csrf
                                <input type="hidden" name="id" value="{{$viewbiz['id']}}">
