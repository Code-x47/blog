            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src={{asset("/entdoc/$viewpost->file1")}} style="object-fit: cover;">
                     ...
                     <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            @foreach($vComment AS $comments)
                                @if($comments['entertainment_id'] == $viewpost['id'])
                            ...
                            @endforeach
                            {{-- <div class="media">
                                <img src="Blog/assets/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                <div class="media-body">
                                ...
                                <div class="media mt-4">
                                        <img src="Blog/assets/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                            style="width: 45px;">
                                        <div class="media-body">
                                            <h6><a class="text-secondary font-weight-bold" href="">John Doe</a> <small><i>01 Jan 2045</i></small></h6>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <form action="/entcomment" method="POST">
                            @csrf
